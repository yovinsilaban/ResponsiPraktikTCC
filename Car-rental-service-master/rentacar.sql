...
CREATE TABLE `transactions` (
  ...
  `pickuptimestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `email` varchar(30) NOT NULL,
  `contact` text NOT NULL,
  `ordertimestamp` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
...
(34, 'yovin silaban', 'SUV 123', '', 0, 'yovin silaban', 'LUCKNOW', '2018-01-31 18:00:00', 'yovinsilaban07@gmail.com', '085357779131', '2018-01-17 07:49:01');
...
('ucok', 'ucok', '085357779131', 'ucok@gmail.com', 'ucok'),
('telo', 'telo', '085758352905', 'telo@gmail.com', 'telo');
...
('SUV 123', 6, 'showcase/a.jpg', -1, 50000, 3000, 500),
('Mahindra ABC', 5, 'showcase/b.jpg', 0, 35000, 2500, 450),
('Hyundai PQR', 4, 'showcase/c.jpg', 0, 30000, 2500, 400),
('Audi 999', 2, 'showcase/d.jpg', 0, 100000, 20000, 1000);
